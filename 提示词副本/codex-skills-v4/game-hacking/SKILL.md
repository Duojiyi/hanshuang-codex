...
Prefer the compiled domain overview at `wiki/overviews/game-hacking.md` (see `wiki/index.md` and `wiki/AGENTS.md`) before re-deriving synthesis from raw README/archive material.
